...
//                               1234567890123456
const char string_0[]  PROGMEM = "  Arduino IDE   ";
const char string_1[]  PROGMEM = " Geiger Counter ";
const char string_2[]  PROGMEM = "TOTAL DOSE   uSv";  
const char string_3[]  PROGMEM = " ";  
const char string_4[]  PROGMEM = " ";  
const char string_5[]  PROGMEM = "SAVED!";  
const char string_6[]  PROGMEM = "Sieverts  ";         
const char string_7[]  PROGMEM = "Roentgen  ";         
const char string_8[]  PROGMEM = "CPM:";               

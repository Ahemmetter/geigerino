...
This code was sucsessfuly compiled on Arduino IDE 1.05 11556 bytes 29 Jan. 2014
------------------------------------------------------------------------------------------------------------------------------
...
or more I recommed to use external voltage multiplier x2 or x3. 
...
7. Fast bargraph on lcd display. No sense for background radiation, but can be very useful for elevated values. Shows counts 
per second measurement.

8. Two tact swith buttons. One to swith units, second to log absorbed data to eeprom.

9. Automatic eeprom logging of absorbed dose once per hour.
...
#define ACTIVE_BUZZER false          // true if active 5V piezo buzzer used. set false if passive soldered. 
...
//LiquidCrystal lcd(15, 6, 14, 13, 12, 11);
//LiquidCrystal lcd(1, 4, 0, 7, 6, 5);
//----------------------------------------------------//
